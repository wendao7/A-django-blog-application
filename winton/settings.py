"""
Django settings for winton project.
...
SECRET_KEY = '*s7h-oyx7ni-^b_aqy1+tqn%^tfq=4t3smdgrjwi20(7#0wqr*'
...
WSGI_APPLICATION = 'winton.wsgi.application'
